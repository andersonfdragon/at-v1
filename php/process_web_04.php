...
// EMPRESA
if (empty($_POST["tipo_empresa_web_01"])) {
    $errorMSG .= utf8_decode("Complete este campo");
} else {
    $tipo_empresa_web_01 = $_POST["tipo_empresa_web_01"];
...
$Subject = "Nuevo lead de sitio web: Formulario Sistemas de Seguridad Web";
...
$Body .= utf8_decode("Tipo empresa: ");
$Body .= utf8_decode($tipo_empresa_web_01);
$Body .= "\n";
