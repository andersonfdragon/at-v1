...
// COMPUTADORES
if (empty($_POST["computadores_web_01"])) {
    $errorMSG .= utf8_decode("Complete este campo");
} else {
    $computadores_web_01 = $_POST["computadores_web_01"];

}

// SERVIDORES
if (empty($_POST["servidores_web_01"])) {
    $errorMSG .= utf8_decode("Complete este campo");
} else {
    $servidores_web_01 = $_POST["servidores_web_01"];

}

//CONTACTOS Y ASUNTO
$Contacts = array('alianzatecdigital@gmail.com');
$Subject = "Nuevo lead de sitio web: Formulario Redes y Cableado Estructurado Web";
...
$Body .= utf8_decode("Número de Computadores: ");
$Body .= utf8_decode($computadores_web_01);
$Body .= "\n";

$Body .= utf8_decode("Número de Servidores: ");
$Body .= utf8_decode($servidores_web_01);
$Body .= "\n";
