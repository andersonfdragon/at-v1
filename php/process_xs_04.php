...
// EMPRESA
if (empty($_POST["tipo_empresa_xs_01"])) {
    $errorMSG .= utf8_decode("Complete este campo");
} else {
    $tipo_empresa_xs_01 = $_POST["tipo_empresa_xs_01"];
...
$Subject = "Nuevo lead de sitio web: Formulario Sistemas de Seguridad Movil";
...
$Body .= utf8_decode($tipo_empresa_xs_01);
$Body .= "\n";
