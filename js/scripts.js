...
$("#contactForm_xs_01").validator().on("submit", function (event) {
    ...
    if ((valido_form_xs)&&(valido_check_xs) === 1) {
        submitForm_xs_01();
...
function submitForm_xs_01(){
    ...
    $.ajax({
        ...
        data: "first_name_xs_01=" + first_name_xs_01 + "&email_xs_01=" + email_xs_01 + "&empresa_xs_01=" + empresa_xs_01 + "&telephone_xs_01=" + telephone_xs_01,
        success : function(text){
            if (text == "success"){
                formSuccess_xs_01();
                window.location.href = "agradecimiento_index.html";
            } else {
...
$('#contactForm_xs_01').on('submit', function(){
...
//Opcion de numero de servidores
$('#contactForm_xs_01').on('submit', function(){
...
function submitForm_web_01(){
    ...
    $.ajax({
        ...
        data: "first_name_web_01=" + first_name_web_01 + "&email_web_01=" + email_web_01 + "&empresa_web_01=" + empresa_web_01 + "&telephone_web_01=" + telephone_web_01,
        success : function(text){
            if (text == "success"){
                formSuccess_web_01();
                window.location.href = "agradecimiento_index.html";
